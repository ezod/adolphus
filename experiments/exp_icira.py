...
# cameras
C = [ \
    ('T1', Pose(Point(272.0795, -512.6482, 1111.6311), Rotation(-3.7496, -6.2382, -6.2694))),
    ...
    ('T8', Pose(Point(559.0332, 497.1981, 1099.4856), Rotation(-2.8116, -5.8239, -4.1621))),
    ...
    ('M4', Pose(Point(586.2451, -625.1676, 591.4391), Rotation(-4.0677, -5.8830, -5.8559))),
    ...
    ('L7', Pose(Point(034.2871, -994.4367, 134.4528), Rotation(-4.6896, -0.0971, -6.2698))),
...
for name, pose in C:
    M[name] = Camera(4.4765, 12.4922, 0.00465, (691.1516, 500.7902), (1360, 1024), 1216.1, 20, 3.0, 0.5, 0.036, 0.3, pose = pose, active = False)
M['T2'].active = True
M['M2'].active = True
M['M4'].active = True
M['L6'].active = True
