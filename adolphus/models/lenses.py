...
class ComputarM3Z1228CMP(VisualizationObject):
    ...
    def __init__(self, parent):
        ...
        self.add('back', visual.cylinder(pos=(0, 0, 9), radius=20,
            axis=(0, 0, 22), color=(0.1, 0.1, 0.1),
            material=visual.materials.plastic))
        self.add('front', visual.cylinder(pos=(0, 0, 31), radius=18,
            axis=(0, 0, 25), color=(0.1, 0.1, 0.1),
            material=visual.materials.plastic))
        self.add('glass', visual.cylinder(pos=(0, 0, 56), radius=17,
            axis=(0, 0, 2), color=(0.3, 0.7, 0.8), opacity=0.5,
            material=visual.materials.plastic))
        self.add('ring', visual.ring(pos=(0, 0, 57), radius=17.5,
