...
class ProsilicaEC1350(VisualizationObject):
    ...
    def __init__(self, parent, frame=None):
        ...
        self.add('body', visual.box(frame=self, length=45, height=33, width=35,
        ...
        self.add('ring', visual.cylinder(frame=self, pos=(0, 0, 0), radius=15,
            ...
            material=visual.materials.plastic))
        self.add('mount', visual.cylinder(frame=self, pos=(0, 0, 4),
            radius=12.5, axis=(0, 0, 5), color=(0.8, 0.8, 0.8),
            material=visual.materials.plastic))
        self.add('back', visual.box(frame=self, length=45, height=33, width=1,
            pos=(0, 0, -35.5), color=(0.29, 0.49, 0.69),
            material=visual.materials.rough))
        self.add('fwport', visual.box(frame=self, length=6, height=12, width=10,
            pos=(16.5, 0, -41.5), color=(0.8, 0.8, 0.8),
            material=visual.materials.plastic))
        self.add('clport', visual.cylinder(frame=self, pos=(-14.5, 0, -36.5),
...
class SICKIVPRangerED(VisualizationObject):
    ...
    def __init__(self, parent, frame=None):
        ...
        if not visual:
            raise VisualizationError("visual module not loaded")
        VisualizationObject.__init__(self, parent, frame)
        self.add('body', visual.box(frame=self, length=49, height=37, width=106,
            pos=(0, -6.5, -44), color=(1, 1, 1),
            material=visual.materials.plastic))
        self.add('top', visual.box(frame=self, length=23, height=13, width=106,
            pos=(0, 18.5, -44), color=(1, 1, 1),
            material=visual.materials.plastic))
        self.add('bevell', visual.cylinder(frame=self, pos=(11.5, 12, 9),
            radius=13, axis=(0, 0, -106), color=(1, 1, 1),
            material=visual.materials.plastic))
        self.add('bevelr', visual.cylinder(frame=self, pos=(-11.5, 12, 9),
            radius=13, axis=(0, 0, -106), color=(1, 1, 1),
            material=visual.materials.plastic))
        self.add('ecport', visual.cylinder(frame=self, pos=(-13.5, 9.5, -97),
            radius=6, axis=(0, 0, -15), color=(0.8, 0.8, 0.8),
            material=visual.materials.plastic))
        self.add('pwport', visual.cylinder(frame=self, pos=(-13.5, -9, -97),
            radius=5, axis=(0, 0, -12), color=(0.8, 0.8, 0.8),
            material=visual.materials.plastic))
        self.add('enport', visual.box(frame=self, length=18, height=22, width=2,
