...
C = Camera( 'C', 4.3214, 12.1, 0.00465, 0.00465, 684.7, 535.24, 1360, 1024, 784.2, 0, 3.0, 0.5, 0.036, 1.5, Pose( Point( -300, 300, -1000 ), rotation_matrix( ( Angle( 0.3 ), Angle( 0.3 ), 0 ) ) ) )
D = Camera( 'D', 4.3214, 12.1, 0.00465, 0.00465, 684.7, 535.24, 1360, 1024, 784.2, 0, 3.0, 0.5, 0.036, 1.5, Pose( Point( 0, 300, 1000 ), rotation_matrix( ( Angle( pi + 0.3 ), 0, Angle( pi ) ) ) ) )
